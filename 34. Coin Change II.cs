...
public class Solution {
    ...
    private static int Recursive(int remain, int[] coins, int index, Dictionary<string, int> dpMemory)
    {
        ...
        var count1 = Recursive(remain - coins[index], coins, index, dpMemory); // the same index= You may assume that you have an infinite number of each kind of coin.
