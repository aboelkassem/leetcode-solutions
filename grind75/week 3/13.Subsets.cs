...
// Using backtracking
// Time:  O(2^n) since you explore all possible subsets, and for each subset,
// you perform constant time operations to add or remove elements from the
// subset list. Space:  O(n)
public class Solution {
  public IList<IList<int>> Subsets(int[] nums) {
  ...
  private void Search(int[] nums, int index, IList<int> temp,
